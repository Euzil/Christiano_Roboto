...
q_actuated_home[8:13] = np.array([0.5, 0.2, 0.0, -0.8, 0.0])           # left arm (l_sho_pitch, l_sho_roll, l_el_pitch, l_el_yaw, l_gripper)
...
q_actuated_home[19:24] = np.array([0.5, -0.2, 0.0, 0.8, 0.0])           # right arm (r_sho_pitch, r_sho_roll, r_el_pitch, r_el_yaw, r_gripper)

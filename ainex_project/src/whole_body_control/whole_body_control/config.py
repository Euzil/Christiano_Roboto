...
q_actuated_home[2:8] = np.array([0.0, 0.0, -0.45, 0.4, 0.20, 0.0])      # left leg (l_hip_yaw, l_hip_roll, l_hip_pitch, ,l_knee, l_ank_pitch, l_ank_roll)
q_actuated_home[8:13] = np.array([0.0, 0.5, 0.0, 0.0, 0.0])             # left arm (l_sho_pitch, l_sho_roll, l_el_pitch, l_el_yaw, l_gripper)
q_actuated_home[13:19] = np.array([0.0, 0.0, 0.45, -0.4, -0.20, 0.0])   # right leg (r_hip_yaw, r_hip_roll, r_hip_pitch, r_knee, r_ank_pitch, r_ank_roll)

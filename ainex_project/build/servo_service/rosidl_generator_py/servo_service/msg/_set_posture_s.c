...
bool servo_service__msg__set_posture__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("servo_service.msg._set_posture", (char *)PyUnicode_1BYTE_DATA(module_attr), 30) == 0);
    assert(strncmp("SetPosture", (char *)PyUnicode_1BYTE_DATA(name_attr), 10) == 0);

...
bool servo_service__msg__set_joint_lock__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("servo_service.msg._set_joint_lock", (char *)PyUnicode_1BYTE_DATA(module_attr), 33) == 0);
    assert(strncmp("SetJointLock", (char *)PyUnicode_1BYTE_DATA(name_attr), 12) == 0);

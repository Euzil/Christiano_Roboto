...
bool servo_service__msg__get_servo_positions__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("servo_service.msg._get_servo_positions", (char *)PyUnicode_1BYTE_DATA(module_attr), 38) == 0);
    assert(strncmp("GetServoPositions", (char *)PyUnicode_1BYTE_DATA(name_attr), 17) == 0);

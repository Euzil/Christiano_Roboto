...
bool servo_service__msg__change_servo_positions__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("servo_service.msg._change_servo_positions", (char *)PyUnicode_1BYTE_DATA(module_attr), 41) == 0);
    assert(strncmp("ChangeServoPositions", (char *)PyUnicode_1BYTE_DATA(name_attr), 20) == 0);

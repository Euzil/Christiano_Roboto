...
def main():
    ...
    try:
        print("=== Tutorial 4: Squatting Controller ===")
        ...
        amplitude = 0.05          # 0.05 m amplitude
        ...
        while rclpy.ok():
            ...
            # Phase 4: Single leg squatting motion (after 7 seconds)
            elif t >= squatting_start_time and left_foot_lifted:
